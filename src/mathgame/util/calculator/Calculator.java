...
//            System.out.println("Expression contains excess operands");
    ...
    public static String toPostfix(String infixExp) {
        ArrayDeque<String> expQueue = queueify(infixExp);
...
//        System.out.println("Queueified expression: " + expQueue.toString());
    ...
    private static ArrayDeque<String> toPostfix(ArrayDeque<String> infixExp) {
